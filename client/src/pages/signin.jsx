        ...
        <div className="flex items-center justify-center ">
                <div className="max-w-screen-md p-4 mt-16">
                    <form method="POST">
                        ...
                        <input value={password} onChange={ev=>setPassword(ev.target.value)} type='password' className="text-lg my-2 font-semibold focus:outline-none font-sans rounded py-2 px-2 lg:px-11 bg-[#f2f2f2] " placeholder='password'></input>
